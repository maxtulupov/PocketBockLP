...
import { isMobile, _slideUp, _slideDown, _slideToggle, MTS } from "../files/functions.js";
...
class SelectConstructor {
	...
	// Логгинг в консоль
	setLogging(message) {
		this.config.logging ? MTS(`[select]: ${message}`) : null;
	}
}
// Запускаем и добавляем в объект модулей
mtsModules.select = new SelectConstructor({});
