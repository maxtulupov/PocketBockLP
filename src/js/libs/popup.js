...
import { isMobile, bodyLockStatus, bodyLock, bodyUnlock, bodyLockToggle, MTS } from "../files/functions.js";
import { mtsModules } from "../files/modules.js";
...
class Popup {
	...
	popupLogging(message) {
		this.options.logging ? MTS(`[Попапос]: ${message}`) : null;
	}
}
// Запускаем и добавляем в объект модулей
mtsModules.popup = new Popup({});