...
import { isMobile, menuClose, getHash, MTS } from "../functions.js";
...
export let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
	...
	if (targetBlockElement) {
		...
		MTS(`[gotoBlock]: Юхуу...едем к ${targetBlock}`);
	} else {
		MTS(`[gotoBlock]: Ой ой..Такого блока нет на странице: ${targetBlock}`);
	}
};